                ...
                <div class="modal-content">
                    <form enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>image</label>
                                <img class="m-2" :src="postToEdit.image" height="60" width="60" style="border:1px solid #999" alt="">
                                <input type="file" id="edit_file" class="form-control" required @change="onImageChanged()" />
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" />
                            <input type="button" class="btn btn-success" value="edit" @click.prevent="updatePost" />
                        </div>
                    </form>
                </div>
            </div>
...
export default {
    ...
    methods:{
        ...
        onImageChanged(event){
            this.postToEdit.image = document.getElementById('edit_file').files[0];
        },
        updatePost(){
            let config = {
